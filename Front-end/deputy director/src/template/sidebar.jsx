...
import { DARSJADVALI, DARSJADVALIOUTLINE, infoUser, infoUserOutline, LISTCLASS, LISTCLASSOUTLINE, logo, myclass, myclassoutline, STUDENT, STUDENTOUTLINE, TEACHER, TEACHEROUTLIN } from '../icons';
    ...
    <div className='p-3 d-flex flex-col gap-3 w-full h-screen bg-darkGray relative z-50'>
      ...
      <div className="flex justify-center flex-col items-stretch">
        <div className="flex flex-col justify-center items-stretch gap-3">
          <BUTTONSIDEBAR barVisible={() => dispatch(openVisible())} slug={'/my-classes'} img={myclass} img2={myclassoutline} name={"Sinflarim"} />
          ...
          <BUTTONSIDEBAR barVisible={() => dispatch(openVisible())} slug={'/list-of-classes'} img={LISTCLASS} img2={LISTCLASSOUTLINE} name={"Sinflar ro'yxati"} />
