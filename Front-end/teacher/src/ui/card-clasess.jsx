...
function CardClasess({ slug, nameOfClass = "1-a", lengthStudent = "12" }) {
  return (
    <div className="tabletIst:w-[330px] minMobil:w-full mobil:w-[250px] h-20 border-card rounded-lg px-3 py-2 flex grow-effect">
      ...
      >
        {nameOfClass} sinf
        <span className="text-textGray font-mono lowercase flex items-start justify-start mt-2 gap-2 text-lg"><img src={COACH} alt="COACH" /> {lengthStudent} ta o‘quvchi</span>
      </Link>
    </div>
  );
}
