...
function ActiveClasses({ nameOfClass, size, slug, id, removeItem, res, changeClass }) {
  ...
  return (
    <div className="no-underline tabletIst:w-[320px] minMobil:w-full mobil:w-[280px] h-20 border-card rounded-lg px-3 py-1 flex flex-col items-start justify-between gap-1">
