...
export { default as savatcha } from './basket.svg'
export { default as savatchaOutline } from './clock-time-tracking 1.svg'


export { default as rating } from './rating.svg'
export { default as ratingOutline } from './Vector (11).svg'


export { default as attendance } from './attendance.svg'
export { default as attendanceOutline } from './Vector (12).svg'
