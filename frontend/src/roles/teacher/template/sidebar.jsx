...
const NAV = [
  ...
  { to: "/time-table", title: "time_table", fallback: "Dars jadvali" },
  { to: "/list-of-classes", title: "list_of_classes_home", fallback: "Sinflar" },
  { to: "/profile", title: "personal_information", fallback: "Shaxsiy ma'lumotlar" },
];
