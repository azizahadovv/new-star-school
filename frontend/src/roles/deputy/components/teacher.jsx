                      ...
                      <div className='w-[150px] flex items-center justify-between relative'>
                        ...
                        <div className="dropdown">
                          ...
                          <div className={`dropdown-menu`}>
                            ...
                            <button onClick={() => remove_Teacher(item?.id, [item?.firstName, item?.lastName, item?.patronymic].filter(Boolean).join(" "))} className="dropdown-item d-flex align-items-center gap-2">
