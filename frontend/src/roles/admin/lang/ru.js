const ruLang = {
  ...
  "v_too_short": "Слишком коротко",
  "v_too_long": "Слишком длинно",
  "v_name": "Только буквы",
  "v_phone": "Неверный номер (например +998901234567)",
  "v_login_short": "Логин минимум 3 символа",
  "v_login_chars": "Логин: только буквы, цифры и _ . -",
  "v_password_short": "Пароль минимум 6 символов",
  "v_date": "Неверная дата",
  "v_date_future": "Дата не может быть в будущем",
  "v_date_old": "Дата слишком старая",
  "v_form_invalid": "Пожалуйста, исправьте ошибки",
  "v_year": "Год должен быть от 2000 до 2100",
  "v_term": "Четверть должна быть от 1 до 4",

  "terms_management": "Управление четвертями",
  "add_term": "Добавить четверть",
  "term_name": "Название четверти",
  "term_year": "Учебный год",
  "term_number": "Номер четверти",
  "term_created": "Четверть создана",
  "term_updated": "Четверть обновлена",
  "term_deleted": "Четверть удалена",
  "term_delete_confirm": "Удалить эту четверть?",

  "school_settings": "Настройки школы",
  "school_name": "Название школы",
  "school_short_name": "Краткое название",
  "school_year": "Учебный год",
  "school_email": "Эл. почта",
  "school_website": "Веб-сайт",
  "school_saved": "Настройки школы сохранены"
};
